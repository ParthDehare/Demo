...
export function GlassBoxEngine({ score = 100, emp_id = "EMP_1024" }) {
  const isCritical = score > 75;
  const hardcodedText = isCritical 
    ? "SHAP Analysis indicates a 98% confidence of structuring. Transaction volume is 400% above 90-day baseline. Agent 4 intercepted high-risk extortion keywords 'urgent transfer'. Isolation Forest flagged abnormal login hours."
    : "SHAP Analysis indicates normal behavior. Transaction volume within standard deviations. No NLP risk factors intercepted. Working hours align with standard baseline.";
